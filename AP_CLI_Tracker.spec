...
a = Analysis(
    ...
    hiddenimports=collect_submodules('worlds') + ['tracker', 'tracker.TrackerClient', 'tracker.TrackerCore', 'tracker.TrackerKivy', 'bsdiff4', 'bsdiff4.core', 'orjson', 'jinja2', 'requests', 'schema', 'colorama', 'typing_extensions', 'pymem'],
    hookspath=[],
    hooksconfig={},
    runtime_hooks=[],
