...
a = Analysis(
    ...
    hiddenimports=collect_submodules_no_import('kivymd') + collect_submodules('worlds') + collect_submodules('pathspec') + collect_submodules('websockets') + ['tracker', 'tracker.TrackerClient', 'tracker.TrackerCore', 'tracker.TrackerKivy', 'tracker_cli', 'bsdiff4', 'bsdiff4.core', 'orjson', 'jinja2', 'requests', 'schema', 'colorama', 'typing_extensions', 'pymem'],
    hookspath=[],
    hooksconfig={},
    runtime_hooks=[],
    excludes=['pygments'],
